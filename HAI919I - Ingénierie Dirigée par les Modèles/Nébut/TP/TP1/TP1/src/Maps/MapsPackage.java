...
public interface MapsPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Bodered By</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PUBLIC_SPACE__BODERED_BY = 1;
	 ...
	 * @ordered
	 */
	int SQUARE__BODERED_BY = PUBLIC_SPACE__BODERED_BY;
	 ...
	 * @ordered
	 */
	int GARDEN__BODERED_BY = PUBLIC_SPACE__BODERED_BY;
	...
	/**
	 * Returns the meta object for the reference list '{@link Maps.PublicSpace#getBoderedBy <em>Bodered By</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Bodered By</em>'.
	 * @see Maps.PublicSpace#getBoderedBy()
	 * @see #getPublicSpace()
	 * @generated
	 */
	EReference getPublicSpace_BoderedBy();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Bodered By</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference PUBLIC_SPACE__BODERED_BY = eINSTANCE.getPublicSpace_BoderedBy();
