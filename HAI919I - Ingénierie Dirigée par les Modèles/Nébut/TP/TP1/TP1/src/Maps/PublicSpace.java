 ...
 *   <li>{@link Maps.PublicSpace#getBoderedBy <em>Bodered By</em>}</li>
 * </ul>
 *
...
public interface PublicSpace extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Bodered By</b></em>' reference list.
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Bodered By</em>' reference list.
	 * @see Maps.MapsPackage#getPublicSpace_BoderedBy()
	 * @see Maps.Road#getBorder
	 * @model opposite="border" required="true"
	 * @generated
	 */
	EList<Road> getBoderedBy();
