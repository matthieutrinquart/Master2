...
public class RoadImpl extends MinimalEObjectImpl.Container implements Road {
	...
	public EList<PublicSpace> getBorder() {
		if (border == null) {
			border = new EObjectWithInverseResolvingEList.ManyInverse<PublicSpace>(PublicSpace.class, this, MapsPackage.ROAD__BORDER, MapsPackage.PUBLIC_SPACE__BODERED_BY);
		}
		return border;
	}
