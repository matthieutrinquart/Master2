...
public class MapsPackageImpl extends EPackageImpl implements MapsPackage {
	 ...
	 * @generated
	 */
	public EReference getPublicSpace_BoderedBy() {
	...
	public void createPackageContents() {
		...
		createEReference(publicSpaceEClass, PUBLIC_SPACE__BODERED_BY);
	...
	public void initializePackageContents() {
		...
		initEReference(getRoad_Border(), this.getPublicSpace(), this.getPublicSpace_BoderedBy(), "border", null, 0, -1, Road.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPublicSpace_BoderedBy(), this.getRoad(), this.getRoad_Border(), "boderedBy", null, 1, -1, PublicSpace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
